...
public class MainActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public void YOLO(View Button){
        ...
        if (startYolo == false){
            ...
            if (firstTimeYolo == false){
                ...
                firstTimeYolo = true;
                String tinyYoloCfg = Environment.getExternalStorageDirectory() + "/dnns/yolov3.cfg" ;
                String tinyYoloWeights = Environment.getExternalStorageDirectory() + "/dnns/yolov3.weights";
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        if (startYolo == true) {
            ...
            Log.i("nimesh",outBlobNames.toString());
            ...
            Log.i("nimesh", String.valueOf(result.size()));
            for (int i = 0; i < result.size(); ++i)
                Log.i("nimesh", outBlobNames.get(i));
            ...
            for (int i = 0; i < result.size(); ++i)
            {
                ...
                for (int j = 0; j < level.rows(); ++j)
                {
                    ...
                    Log.i("nimesh","above iffffffffffffffffff");
                    if (confidence > confThreshold)
                    {
                        Log.i("nimesh","above belowwwwwwwwwwwwwwwwwwww");
